# JAVA++ (JPP) - Esolang
![Stars](https://shields.io)![Last Commit](https://shields.io)
...
**WINDOWS*
Open **PowerShell** as an Administrator and execute the script. If your system blocks script execution, run it with the bypass policy:
```powershell
...
**LINUX/MacOS** 
Before running the script, make sure to grant it executable permissions:
```bash
chmod +x install.sh
./install.sh
```
...
## INSTALL RELEASE
binary starting in `release` in GitHub
**Linux only—sorry, I'm on Linux, and Nuitka doesn't support cross-compilation, so you'll have to install it yourself using Nuitka or PyInstaller.**

- **Documentation**: [guide: guide.md](./guide/guide.md)
